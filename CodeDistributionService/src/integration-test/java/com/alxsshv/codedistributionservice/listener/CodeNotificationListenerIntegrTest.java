...
import com.alxsshv.codedistributionservice.AbstractIntegrationTest;
...
class CodeNotificationListenerIntegrTest extends AbstractIntegrationTest {
    ...
    void testKafkaListener()  {
        ...
        verify(emailSendingService, timeout(1000).times(1)).send(email, code);
    }
